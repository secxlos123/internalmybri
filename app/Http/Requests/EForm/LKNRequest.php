...
class LKNRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
           ...
           // 'work_letter'                => 'required|mimes:jpg,jpeg,png,gif,svg,rar,pdf,zip',
           // 'family_card'                => 'required|mimes:jpg,jpeg,png,gif,svg,rar,pdf,zip',
           // 'marrital_certificate'       => 'required|mimes:jpg,jpeg,png,gif,svg,rar,pdf,zip',
           // 'divorce_certificate'        => 'required|mimes:jpg,jpeg,png,gif,svg,rar,pdf,zip',
           // 'offering_letter'            => 'required|mimes:jpg,jpeg,png,gif,svg,rar,pdf,zip',
           ...
           'legal_bussiness_document'   => 'required',
           'licence_of_practice'        => 'required',
           'work_letter'                => 'required',
           'family_card'                => 'required',
           'marrital_certificate'       => 'required',
           'divorce_certificate'        => 'required',
           'offering_letter'            => 'required',
           'down_payment'               => '',
           'building_tax'               => '',
           'photo_with_customer'        => 'required',
           'building_permit'            => 'required_if:use_reason,2,18',
           'proprietary'                => 'required_if:use_reason,2,18',

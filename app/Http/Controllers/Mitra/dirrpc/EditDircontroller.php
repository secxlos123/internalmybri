...
class EditDircontroller extends Controller
{
    ...
    public function index()
    {
		...
		$view = $view['contents'];
		return view('internals.mitra.dirrpc.dirrpc_edit',  compact('data','view','clients','clients_detail'));
    }
...
//			die();
		...
		$data = $this->getUser();
		$client = Client::setEndpoint('update_detail')
				->setHeaders([
					'Authorization' => $data['token'],
					'pn' => $data['pn']
				])

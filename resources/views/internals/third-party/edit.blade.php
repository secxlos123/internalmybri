@section('title','My BRI - Edit Pihak Ke-3')
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Edit Pihak Ke-3</h4>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-horizontal" role="form">
                                                <div class="form-group email {!! $errors->has('email') ? 'has-error' : '' !!}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="email" class="form-control" name="email" required="" maxlength="50" value="{{$datas['email']}}">

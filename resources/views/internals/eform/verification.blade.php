                ...
                <div class="content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle" id="nameCIF">{{$dataCustomer['kemendagri']['name']}}</td>
                                                <td class="align-middle" id="nameKM">{{$dataCustomer['cif']['name']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="birth_dateCIF">{{$dataCustomer['kemendagri']['birth_date']}}</td>
                                                <td class="align-middle" id="birth_dateKM">{{$dataCustomer['cif']['birth_date']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="addressCIF">{{$dataCustomer['kemendagri']['address']}}</td>
                                                <td class="align-middle" id="addressKM">{{$dataCustomer['cif']['address']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="genderCIF">{{$dataCustomer['kemendagri']['gender']}}</td>
                                                <td class="align-middle" id="genderKM">{{$dataCustomer['cif']['gender']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="statusCIF">{{$dataCustomer['kemendagri']['status']}}</td>
                                                <td class="align-middle" id="statusKM">{{$dataCustomer['cif']['status']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="address_statusCIF">{{$dataCustomer['kemendagri']['address_status']}}</td>
                                                <td class="align-middle" id="address_statusKM">{{$dataCustomer['cif']['address_status']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="phoneCIF">{{$dataCustomer['kemendagri']['phone']}}</td>
                                                <td class="align-middle" id="phoneKM">{{$dataCustomer['cif']['phone']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="mobile_phoneCIF">{{$dataCustomer['kemendagri']['mobile_phone']}}</td>
                                                <td class="align-middle" id="mobile_phoneKM">{{$dataCustomer['cif']['mobile_phone']}}</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" id="mother_nameCIF">{{$dataCustomer['kemendagri']['mother_name']}}</td>
                                                <td class="align-middle" id="mother_nameKM">{{$dataCustomer['cif']['mother_name']}}</td>
                                                <td>
                    ...
                    <form action="{{route('verifyData', $id)}}" method="POST" enctype="multipart/form-data" id="form1">
                        ...
                        {{ method_field('PUT') }}
                            ...
                            <input type="hidden" name="birth_place" value="{{$dataCustomer['customer']['birth_place']}}" id="birth_place">

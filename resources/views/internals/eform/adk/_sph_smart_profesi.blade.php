...
<p class="right"><font size="0">1/6</font></p>
...
<!-- pasal 1 -->
<p class="right"><font size="0">2/6</font></p>
<p class="justify">
...
<p class="justify">
  ...
  <ol class="justify">
    ...
    <li>
      YANG BERHUTANG dapat melakukan penurunan pokok sebagian apabila jangka waktu Pinjaman telah berjalan minimal 6 (enam bulan) dengan jumlah penyetoran untuk penurunan pokok sebagian yaitu minimal sebesar 3x angsuran pokok dan bunga pada bulan berjalan atau maksimal sebesar 50% (lima puluh persen) dari sisa outstanding/baki debet pinjaman Briguna.<br>
      Sebelum melakukan penyetoran untuk penurunan pokok sebagian, maka YANG BERHUTANG diwajibkan:
      <ol type="a">
        <li>Memberi informasi kepada BANK sehubungan dengan adanya rencana penurunan pokok sebagian;</li>
        <li>Mengisi Formulir Penurunan Pokok Sebagian; dan</li>
        <li>Membuat Surat Kuasa apabila suami/ istri tidak dapat menandatangani Formulir Penurunan Pokok Sebagian.</li>
        <li>Membayar seluruh kewajiban yang harus dipenuhi sampai dengan periode bulan berjalan.</li>
      </ol>
    </li>
  </ol>
  <br>
  ...
  <ol class="justify">
    <li>
      ...
      <ol type="a">
        ...
        <p class="right"><font size="0">3/6</font></p>
        <li>
...
<p class="justify">
  ...
  <ol class="justify">
    <li>
      Sumber pembayaran angsuran pinjaman YANG BERHUTANG kepada BANK dapat bersumber dari <font size='1'>6)</font> :
      <ol type="a">
        <li>
        ...
        <li>
          Segala hak dari YANG BERHUTANG ({{$data_sph['nama_debitur']}})<font size='1'>7)</font> berupa uang pensiun selaku pensiunan yang kepesertaan pensiunnya diterangkan dalam Surat Keputusan Pensiun Nomor .......................... tanggal ...........................
        </li>
        <li>
    ...
    <li>
      ...
      <ol type="a">
        ...
        <li>
          Agunan Tambahan:................................ <font size='1'>9)</font>
        </li>
      </ol>
    </li>
    <li>
  ...
  <br><br>
  <hr>
  <font size='1'><i>5) Kata biaya-biaya tersebut……dst, dicoret apabila biaya-biaya (provisi, administrasi dan/atau premi asuransi) dipotong dari pinjaman.</i></font><br>
  <font size='1'><i>6) Dicoret jenis agunan yang tidak digunakan</i></font><br>
...
<!-- pasal 5 -->
<p class="right"><font size="0">4/6</font></p>
<p class="justify">
...
<p class="justify">
  ...
  <hr>
  <font size='1'><i>10) Diisi nama YANG BERHUTANG yang diasuransikan sesuai ketentuan</i></font><br>
  <font size='1'><i>11) Dicoret butir 2 apabila tidak ada agunan kebendaan </i></font><br>
</p>
<p class="right"><font size="0">5/6</font></p>
<p class="justify">
  <ol class="justify" start="3">
    <li>
...
<br>
<p class="right"><font size="0">6/6</font></p>
<!-- pasal 10 -->
<p class="justify">
...
<p class="justify">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian, Surat Pengakuan Hutang ini dibuat tanpa didasarkan atas unsur paksaan, kekhilafan, penipuan dan penyalahgunaan keadaan, serta berlaku sejak tanggal ditandatanganinya.<br>
  <table width="100%">
    <tr>

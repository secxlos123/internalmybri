        ...
        <div class="col-md-8">
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="npwp" accept="image/*,application/pdf,application/rar">
                ...
                <div class="form-group" id="salary_slip">
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="salary_slip" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <div class="form-group" id="legal_bussiness_document">
                    <label class="col-md-6 control-label">Dokumen Legal Usaha * :</label>
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="legal_bussiness_document" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group" id="work_letter">
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="work_letter" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-6 control-label">Kartu Keluarga * :</label>
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="family_card" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                ...
                <div class="form-group" id="marrital_certificate">
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="marrital_certificate" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                @endif
                <!-- <div class="form-group">
                ...
                <div class="form-group" id="separate_certificate">
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="divorce_certificate" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                @endif
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="offering_letter" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <div class="form-group" id="shm" @if($eformData['kpr']['developer_id'] != 1) hidden="" @endif>
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="proprietary" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <div class="form-group" id="imb" @if($eformData['kpr']['developer_id'] != 1) hidden="" @endif>
                    ...
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="building_permit" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-6 control-label">Bukti DP </label>
                    <div class="col-md-6">
                        <input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="glyphicon glyphicon-folder-open" data-placeholder="Tidak ada file" name="down_payment" accept="image/*,application/pdf,application/rar">
                    </div>
                </div>
                <div class="form-group">

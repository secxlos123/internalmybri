                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="form-control address_status" name="address_status_id">
                                        <option disabled="" selected="">-- Pilih --</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    {!! Form::select('citizenship', [$dataCustomer['customer']['citizenship_id']['desc1'] => $dataCustomer['customer']['citizenship_id']['desc2']], old('citizenship'), [

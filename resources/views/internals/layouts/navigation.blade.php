<div class="left side-menu">
  <div class="sidebar-inner slimscrollleft" style="overflow: hidden;">
    <div id="sidebar-menu">
      ...
      <li>
        <a href="{{route('monitoring.index')}}" class="waves-effect"><i class="mdi mdi-monitor-multiple"></i> <span> Monitoringasdasdasd </span> </a>
      </li>
      @endif
      <li class="treeview">
...
@if($data['role_user'] != 'ao' || $data['role_user'] != 'fo' || $data['role_user'] != 'mantri' || $data['role_user'] != 'cs' || $data['role_user'] != 'ro' || $data['role_user'] != 'adk')
<li class="treeview">

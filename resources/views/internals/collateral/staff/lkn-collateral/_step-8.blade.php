            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control numericOnly" name="eight[binding_number]" value="0" id="binding_number" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <span class="input-group-addon b-0">Rp</i></span>
                                <input type="text" class="form-control numericOnly currency-rp" name="eight[binding_value]" maxlength="50" value="0" id="binding_value">
                            </div>
                        </div>
                    </div>
                </div>

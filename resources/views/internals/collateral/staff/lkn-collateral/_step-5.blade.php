                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker-maxdate" name="valuation[scoring_land_date]" value="{{date('Y-m-d')}}" id="scoring_land_date">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker-maxdate" name="valuation[scoring_building_date]" value="{{date('Y-m-d')}}" id="scoring_building_date">
                                        <span class="input-group-addon b-0"><i class="mdi mdi-calendar"></i></span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker-maxdate" name="valuation[scoring_all_date]" value="{{date('Y-m-d')}}" id="scoring_all_date">
                                        <span class="input-group-addon b-0"><i class="mdi mdi-calendar"></i></span>
                                    </div>
                                </td>
                                <td>

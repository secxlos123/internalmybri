                            ...
                            <div class="col-md-12">
                                <div class="">
                                    <ul class="nav nav-tabs">
                                        <li class="{{($form_notif['developer_id'] != 1) ? 'active': ''}}">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane {{($form_notif['developer_id'] != 1) ? 'active': ''}}" id="developer">
                                            <div class="row">
                                                <div class="col-md-12">
                                                                        ...
                                                                        <table id="datatable" class="table table-bordered">
                                                                            ...
                                                                            @If(count($form_notif) > 0 && $form_notif['developer_id'] != 1)
                                                                                  <tbody>
                                                                                    ...
                                                                                    <td> {{ $form_notif['prop_name'] }} </td>
                                                                                    <td> {{ $form_notif['prop_city_name'] }} </td>
                                                                                    <td> {{ $form_notif['prop_types'] }} </td>
                                                                                    <td> {{ $form_notif['prop_items'] }} </td>
                                                                                    <td> {{ $form_notif['prop_pic_name'] }} </td>
                                                                                    <td> {{ $form_notif['prop_pic_phone'] }} </td>
                                                                                    <td> {{ $form_notif['staff_name'] }} </td>
                                        ...
                                        <div class="tab-pane {{($form_notif['developer_id'] == 1) ? 'active': ''}}" id="independent">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="tab-scroll table-responsive">
                                                                        <table id="datatable-independent" class="table table-bordered">
                                                                            ...
                                                                            <tbody>
                                                                                    <tr role="row" class="odd">
                                                                                    <td> {{ $form_notif['first_name'] }} </td>
                                                                                    <td> {{ $form_notif['home_location'] }} </td>

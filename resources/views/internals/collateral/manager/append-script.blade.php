    ...
    $(document).on('click', "#view-detail", function(){
        ...
        $.ajax({
            ...
            //step1
                ...
                var distance = result.data.ots_in_area.distance;
                var unit_type = result.data.ots_in_area.unit_type;
                ...
                var distance_of_position = result.data.ots_in_area.distance_of_position;
                ...
                var surface_area = result.data.ots_in_area.surface_area;
            ...
            //step2 
                ...
                var surface_area_by_letter = result.data.ots_letter.surface_area_by_letter;
            ...
            //step3
                ...
                var building_type = result.data.ots_building.type;
                ...
                var building_north_limit = result.data.ots_building.north_limit;
                var building_north_limit_from = result.data.ots_building.north_limit_from;
                var building_east_limit = result.data.ots_building.east_limit;
                var building_east_limit_from = result.data.ots_building.east_limit_from;
                var building_south_limit = result.data.ots_building.south_limit;
                var building_south_limit_from = result.data.ots_building.south_limit_from;
                var building_west_limit = result.data.ots_building.west_limit;
            ...
            //step4
                ...
                var designated = result.data.ots_environment.designated;
                ...
                var distance_from_transportation = result.data.ots_environment.distance_from_transportation;
            ...
            //step1
                ...
                $("#detail-collateral-modal #distance_of_position").html(distance_of_position);
            ...
            //step3
                ...
                $("#detail-collateral-modal #building_count").html(building_count);
            ...
            //step4
                ...
                $("#detail-collateral-modal #other_guide").html(other_guide+' M<sup>2</sup>');

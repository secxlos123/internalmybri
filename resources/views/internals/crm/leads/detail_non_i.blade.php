                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="infoNasabah">
                            ...
                            <br>
                            <span>{{$info['nama_pengurus_1']}}</span>
                          </div>
                          <div class="infoNasabah">
                            <label for="">Jabatan Pengurus</label>
                            <br>
                            <span>{{$info['jabatan_pengurus_1']}}</span>
                          </div>
                          <div class="infoNasabah">
                            <label for="">Telepon Pengurus</label>
                            <br>
                            <span>{{$info['telepon_pengurus_1']}}</span>
                          </div>
                          <div class="infoNasabah">
                            <label for="">Nama Pengurus</label>
                            <br>
                            <span>{{$info['nama_pengurus_2']}}</span>
                          </div>
                          <div class="infoNasabah">
                            <label for="">Jabatan Pengurus</label>
                            <br>
                            <span>{{$info['jabatan_pengurus_2']}}</span>
                          </div>
                          <div class="infoNasabah">
                            <label for="">Telepon Pengurus</label>
                            <br>
                            <span>{{$info['telepon_pengurus_2']}}</span>
                          </div>
                        </div>
                      </div>
                    </div>

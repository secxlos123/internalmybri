...
document.getElementById("hasil_penilaian_scoring").readOnly = true;
document.getElementById("periode_penilaian").readOnly = true;
document.getElementById("id_mitra").readOnly = true;
document.getElementById("tgl_hasil_scoring").readOnly = true;
$(document).on('click', "#btn-submit", function(){
	...
	formarray.push({
			...
			"value": $("#rekomendasi_unit_kerja").val()
	});
		sentform(formarray);
})

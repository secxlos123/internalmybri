...
#load{
    ...
    <div class="content-page">
		...
		<form action="ApprovalStore" method="post" enctype="multipart/form-data">
			...
			<div class="panel panel-color panel-primary">
				<div class="col-md-12">
					<div class="panel-heading">
						...
						<div class="col-md-8">
							<select id="fasilitas_jasa" name="fasilitas_jasa"><option value="simpanan">SIMPANAN</option><option value="simpanan">SIMPANAN</option></select>
						</div>
				</div>
				<div class="col-md-12">
					<div class="col-md-4">

                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-horizontal" >
												...
												<div class="form-group payroll">
                                                    ...
                                                    <div class="col-md-7">
													   <input type="radio" id="payroll"
														...
														<label for="payroll">BANK BRI</label>
													   <input type="radio" id="payroll"
                                                ...
                                                <div class="form-group admin_fee">
                                                    <label class="col-md-5 control-label">Admin Fee % :</label>
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control numericOnly" 
														 onchange="validasi_desimal(#persen_bunga)" step="0.01"
														 onkeypress="event.charCode == 46 || event.charCode == 0"
														name="admin_fee" id="admin_fee" value="{{ old('admin_fee') }}" >
													</div>
                                                </div>
												...
												<div class="form-group dir_rpc">
                                                    ...
                                                    <div class="col-md-7">
													<select class="form-control" id="dir_rpc" name="dir_rpc" >
													<option disabled="" value="" selected="">-- Pilih --</option>
														  <?php if(count($dir_rpc) > 0){
															foreach ($dir_rpc as $value) {
																?><option value="<?php echo $value['no'];?>"><?php echo $value['debt_name'];?></option>
														  <?php }}?>
													</select>
												...
												<div class="form-group asuransi_jiwa">
                                                    <label class="col-md-5 control-label">Asuransi Jiwa :</label>
                                                    <div class="col-md-7">
                                                        <select class="form-control" name="asuransi_jiwa" id="asuransi_jiwa">
                                                            <option disabled="" value="" selected="">-- Pilih --</option>
                                                            <option value="Item1">Item1</option>
                                                            <option value="Item2">Item2</option>
                                                            <option value="Item3">Item3</option>
										...
										<div class="col-lg-12">
											<div class="form-horizontal" >
													<div class="form-group first_month {!! $errors->has('first_month') ? 'has-error' : '' !!}">
														...
														<div class="col-md-11">
															<input type="text" class="form-control numericOnly" name="first_month" id="first_month" value="1" readonly>

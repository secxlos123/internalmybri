@section('title','MyBRI - Edit Profil Calon Debitur')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Edit Profil Calon Debitur</h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li>
                                <a href="{{route('customers.index')}}">Profil Calon Debitur</a>
                            </li>
                            <li class="active">
                                Edit Profil Calon Debitur
                            </li>
                        </ol>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group images {!! $errors->has('images') ? 'has-error' : '' !!}">
                                                <label class="col-md-4 control-label">Foto Profil Calon Debitur *:</label>
                                                <div class="col-md-8">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p>Apakah Anda yakin ingin mengubah Profil Calon Debitur "<b id="name"></b>" ?</p>
                        </div>
                    </div>
                </div>

@section('title','My BRI - Detail Profil Customer')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Detail Profil Customer "{{$dataCustomer['personal']['name']}}" </h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li>
                                <a href="{{route('customers.index')}}">Profil Customer</a>
                            </li>
                            <li class="active">
                                                    ...
                                                    <div class="col-md-6">
                                                        <form class="form-horizontal" role="form">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <p class="form-control-static">@if(isset($dataCustomer['work']['work_duration'])){{$dataCustomer['work']['work_duration']}} Tahun {{$dataCustomer['work']['work_duration_month']}} Bulan @else - @endif</p>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6" align="center">
                                                        <div class="card-box">
                                                            @if((pathinfo(strtolower($dataCustomer['other']['identity']), PATHINFO_EXTENSION) == 'jpg') || (pathinfo(strtolower($dataCustomer['other']['identity']), PATHINFO_EXTENSION) == 'png') || (pathinfo((strtolower($dataCustomer['other']['identity'])), PATHINFO_EXTENSION) == 'jpeg'))
                                                                ...
                                                                <p>Foto KTP Kosong</p>
                                                                @else
                                                                <img src="@if(!empty($dataCustomer['other']['identity'])){{$dataCustomer['other']['identity']}}@endif" class="img-responsive imageZoom">
                                                                <p>Foto KTP</p>
                                                                @endif
                                                            @else
                                                    ...
                                                    <div class="col-md-6" align="center">
                                                        <div class="card-box">
                                                            @if((pathinfo(strtolower($dataCustomer['personal']['couple_identity']), PATHINFO_EXTENSION) == 'jpg') || (pathinfo(strtolower($dataCustomer['personal']['couple_identity']), PATHINFO_EXTENSION) == 'png') || (pathinfo((strtolower($dataCustomer['personal']['couple_identity'])), PATHINFO_EXTENSION) == 'jpeg'))
                                                                ...
                                                                @else
                                                                <img src="@if(!empty($dataCustomer['personal']['couple_identity'])){{$dataCustomer['personal']['couple_identity']}}@endif" class="img-responsive imageZoom">

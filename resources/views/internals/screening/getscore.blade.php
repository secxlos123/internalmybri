                                                ...
                                                <div class="card-box">
													...
													<input type="hidden" id="countupload" name="countupload" value="2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control numericOnly required" id="pefindo_score" name="pefindo_score">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">Keterangan Resiko :</label>
                                                            <div class="col-sm-4">
																<textarea id="ket_risk" name="ket_risk"  class="form-control required" rows="8"/></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label">Upload</label>
                                                            <div class="col-sm-4">
																<input type="file" data-placeholder="Tidak ada file" name="uploadscore"  id="uploadscore" accept=".pdf">
																<div id="tambah">
																</div>
															</div>
															<div class="col-sm-1">
...
$('#addupload').click(function() {
	...
	var k = '<input type="file" class="filestyle" data-buttontext="Unggah" data-buttonname="btn-default" data-iconname="fa fa-cloud-upload" data-placeholder="Tidak ada file" name="uploadscore'+countupload+'"  id="uploadscore'+countupload+'" accept=".pdf">';
	$('#tambah').append(k);

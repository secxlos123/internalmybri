...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>List Pengajuan PDF</title>
    ...
    <body>
        <div class="page-content">
            ...
            <table class="full-width">
                <tbody>
                    <tr>
                        <td class="title" colspan="2">DATA PENGAJUAN</td>
                    </tr>
                </tbody>
            </table>
            <table class="full-width tg" border="0" >
                <thead>
                    <tr>
                        <th>No. Ref</th>
                        <th>Nasabah</th>
                ...
                @if(count($generateEform) > 0)
                    ...
                    <tr>
                        ...
                        <td align="center">{{ substr($data['created_at'], 0,-8) }}</td>
